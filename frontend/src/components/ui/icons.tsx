...
// Status Icons
export function Loader2Icon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg {...defaultProps} width={size} height={size} className={className} {...props}>
...
// Communication Icons
export function MessageSquareIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg {...defaultProps} width={size} height={size} className={className} {...props}>
...
export function StethoscopeIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg {...defaultProps} width={size} height={size} className={className} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75a3 3 0 0 0 3 3h.75a3 3 0 0 0 3-3V5.25a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v7.5a3 3 0 0 0 3 3h.75a3 3 0 0 0 3-3V9.75M7.5 9V6.75A2.25 2.25 0 0 1 9.75 4.5h4.5a2.25 2.25 0 0 1 2.25 2.25V9m-9 0h9m-9 0a1.5 1.5 0 0 0-1.5 1.5v1.5a1.5 1.5 0 0 0 1.5 1.5m9-4.5a1.5 1.5 0 0 1 1.5 1.5v1.5a1.5 1.5 0 0 1-1.5 1.5" />
    </svg>
  );
}
...
export function PillIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg {...defaultProps} width={size} height={size} className={className} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m4.243 19.757 15.514-15.514a2.25 2.25 0 0 1 3.182 3.182L7.425 22.939a2.25 2.25 0 0 1-3.182-3.182ZM12 12l3.5-3.5" />
    </svg>
  );
}
...
// Languages Icon
export function LanguagesIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg {...defaultProps} width={size} height={size} className={className} {...props}>
