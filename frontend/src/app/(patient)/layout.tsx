...
export default function PatientLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    {
      href: '/conversations',
      label: t('conversations', { defaultValue: 'Chat' }),
      icon: MessageCircle,
    },
    {
  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main
          id="main-content"
          className="flex-1 overflow-y-auto relative w-full max-w-lg md:max-w-4xl mx-auto animate-in fade-in duration-500 bg-muted/20 pt-[60px] md:pt-0"
        >
          {children}
          <OnboardingModal />
        </main>
