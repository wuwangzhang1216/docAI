...
from sqlalchemy import Boolean, Column, Date, DateTime, Float, ForeignKey, SmallInteger, String, Text, UniqueConstraint
...
class DailyCheckin(Base):
    ...
    __table_args__ = (UniqueConstraint("patient_id", "checkin_date", name="uq_patient_checkin_date"),)
